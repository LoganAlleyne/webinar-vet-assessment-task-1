<template>
    <div>
        ...
        <input 
            type="text" 
            name="video_length" 
            v-model="editedVideo.video_length" 
        ...
        <input 
            type="date" 
            name="created_at" 
            v-model="editedVideo.created_at" 
...
<script setup>
    ...
    // Define the original video object
    const originalVideo = store.currentVideo

    // Define the edited video object
    const editedVideo = ref({
        id: store.currentVideo.id,
        name: originalVideo.name,
        slug: originalVideo.slug,   
        description: originalVideo.description,
        video_length: originalVideo.video_length,
        created_at: originalVideo.created_at
    })

    // Function to add a new video
    const saveChanges = () => {
        store.updateVideo(editedVideo.value)
